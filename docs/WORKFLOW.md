...
| T-008          | 依赖供应链治理（dependabot+pnpm audit+wrangler）                                                                                                                            | P2     | 已完成 | opencode/muse-spark | T-005 | 5e966d4 dependabot.yml npm+actions weekly wrangler major ignore +ci audit job pnpm audit 1 high (brace-expansion) 需 dependabot 修复 yaml ok                                                                                                                                                                                 |
| T-009          | Markdown 内容去占位与信息一致性                                                                                                                                             | P2     | 已完成 | opencode/muse-spark | T-006 | 916121a 清理 YOUR_FORM_LINK 占位 +QQ 同步为联系队长获取 join/team/en 同步 pnpm build 无 MDX 警告 ✅                                                                                                                                                                                                                          |
| T-010          | 测试覆盖率补齐至 70%（回收 vitest exclude）                                                                                                                                 | P1     | 已完成 | opencode/muse-spark | T-005 | fbd5784 补 6 套件 257 tests 覆盖率 84/71 全量 70 达标 移除 exclude purgeCSS 修复排版/搜索                                                                                                                                                                                                                                    |
| T-011          | P3.3 告警闭环（Feishu/WeCom + 自动阈值告警）                                                                                                                                | P1     | 已完成 | opencode/muse-spark | T-005 | a760827 扩展 alerts.feishu/wecom +checkPerformanceAndAlert 12 用例 覆盖率 84/72 269 tests                                                                                                                                                                                                                                    |
| T-012          | HUAT FSAC 官网评审整改（Hero 9MB/移动端导航/可读性/SEO 全量修复）                                                                                                           | P0     | 已完成 | opencode/muse-spark | -     | 本轮 37 files 含 10 张重压 + picture srcset 768/1440 avif/webp + Header 50rem + Hero scrim + h1唯一 + Umami条件 + @fontsource + \_headers immutable/must-revalidate + sponsors 3项 + mobile-header 3用例，验证 build ✅ test 269 ✅ e2e 92+3 ✅ theme ok                                                                     |
| T-013          | 开源合规基线（批1：MIT+组织版权 / CODEOWNERS 双层 / CODE_OF_CONDUCT / SUPPORT / .editorconfig / .nvmrc / package.json 元信息 / README 中英双语 / Issue config Discussions） | P0     | 待办   | opencode/muse-spark | -     | 改 LICENSE 2026 zhangjszs->HUAT FSAC · 包 LICENSE/CODE_OF_CONDUCT/SUPPORT/EDITORCONFIG/NVMRC · package.json description/keywords/repository/homepage/bugs/license/author · README.md+README.en.md · CODEOWNERS 个人+团队双层 · 改 ISSUE_TEMPLATE/config.yml 启用 Discussions · 验证 pnpm install + pnpm lint + pnpm build ✅ |
| T-014          | 文档与架构梳理（批2：ARCHITECTURE / ROADMAP / CONTRIBUTING-content / social-preview / welcome.yml / stale.yml / doc issue template）                                        | P1     | 待办   | opencode/muse-spark | T-013 | 新增 ARCHITECTURE.md(目录树+模块依赖+数据流+SSR链路) · 抽 docs/CONTRIBUTING-content.md(MDX/Asset/Starlight) · 抽 docs/ROADMAP.md(从 TODOLIST P0-P4) · .github/social-preview.png 1280x640 · welcome.yml 首次 PR 评论 · stale.yml 关闭僵尸 issue · ISSUE_TEMPLATE/documentation.yml · 验证 build ✅ docs 可读                 |
| T-015          | 自动化与发布（批3：release-please / labeler / secret scan / Makefile）                                                                                                      | P2     | 待办   | opencode/muse-spark | T-014 | release-please.yml 常规提交生成 CHANGELOG+Release · .github/labeler.yml 自动打 PR 标签 · .husky/pre-commit + .github/workflows 接入 gitleaks 防止密钥泄露 · Makefile 一键 make dev/build/test/lint/deploy · 验证 release-please bot 初始化 PR + secret scan 试例 OK                                                          |
| _在此追加新行_ |                                                                                                                                                                             |        |        |                     |       |                                                                                                                                                                                                                                                                                                                              |
...
| 2026-08-28 | opencode/muse-spark | 认领 T-008                 | 直接在 main 开发（P2 供应链治理）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| 2026-08-28 | opencode/muse-spark | 完成 T-008 已完成          | Handoff: T-008 已完成 直接在 main 提交 5e966d4 dependabot.yml weekly npm+actions wrangler major ignore +ci audit job pnpm audit 验证 yaml ok ✅ pnpm audit 1 high 已披露 需上游修复 风险 低 全迭代 P0-P2 已闭环                                                                                                                                                                                                                                                                                                                                                                                                     |
| 2026-08-28 | opencode/muse-spark | 认领 T-009                 | 直接在 main 开发（P2 MD 内容去占位）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-08-28 | opencode/muse-spark | 完成 T-009 已完成          | Handoff: T-009 已完成 直接在 main 提交 916121a 清理 src/content/docs/join.mdx YOUR_FORM_LINK 占位+QQ 123456789 同步 team.mdx/en/join.mdx 为联系队长获取 验证 grep 占位 0 ✅ pnpm build 无 MDX 警告 ✅ 风险 低 全量 MD 已去占位                                                                                                                                                                                                                                                                                                                                                                                      |
| 2026-08-28 | opencode/muse-spark | 认领 T-010                 | 直接在 main 开发（P1 覆盖率补齐至 70）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-08-28 | opencode/muse-spark | 完成 T-010 已完成          | Handoff: T-010 已完成 直接在 main 提交 fbd5784 修复 purgeCSS 导致排版/搜索图标问题 +补 6 测试套件 覆盖率 71 全量 70 达标 验证 layout-check 3/3 ✅ 风险 低 全迭代闭环                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-08-28 | opencode/muse-spark | 认领 T-011                 | 直接在 main 开发（P1 P3.3 告警闭环）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| 2026-08-28 | opencode/muse-spark | 完成 T-011 已完成          | Handoff: T-011 已完成 直接在 main 提交 a760827 src/config/monitoring.ts 补 feishu/wecom +checkPerformanceAndAlert 12 用例 覆盖率 72 269 tests 验证 lint/build ✅ 风险 低 P3 剩余 10% 闭环                                                                                                                                                                                                                                                                                                                                                                                                                           |
| 2026-08-29 | opencode/muse-spark | 认领 T-012                 | 直接在 main 开发（P0 评审整改，含 Hero 9MB→294KB、移动端双导航、遮罩可读性、SEO 多h1/Umami/字体/i18n）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| 2026-08-29 | opencode/muse-spark | 完成 T-012 已完成          | Handoff: T-012 已完成 分支 main（单人）改动 astro.config/ Header/Hero/Stats/TeamMembers/JoinUs/PageTitle/security/\_headers + 10 图重压 + picture 768/1440 avif/webp + sponsors 3项 + mobile-header.spec 3用例 验证 pnpm build ✅ pnpm test:run 269 ✅ pnpm test:e2e 95 ✅ pnpm quality:theme ok ✅ 风险 低（/assets 未哈希用 must-revalidate） 下一步 无                                                                                                                                                                                                                                                           |
| 2026-09-01 | opencode/muse-spark | 认领 T-013                 | 直接在 main 开发（P0 开源合规基线 · 批1：MIT+组织版权/CODEOWNERS/CODE_OF_CONDUCT/SUPPORT/editorconfig/nvmrc/package.json元信息/中英README/Issue config）                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| 2026-09-01 | opencode/muse-spark | 完成 T-013 已完成          | Handoff: T-013 已完成 直接在 main 提交 改动 8 文件 + 新增 5 文件：LICENSE 2026 zhangjszs->HUAT FSAC · 新增 CODE_OF_CONDUCT.md（CC v2.1 中英）/ SUPPORT.md（zh+en）/ .editorconfig / .nvmrc=22.23.2 / README.en.md（英文版）· package.json 补 description/license/author/homepage/repository/bugs/keywords/funding/private · CODEOWNERS 个人+团队双层 + 追加关键路径 · ISSUE_TEMPLATE/config.yml 加 Discussions 链接 + README.md 全面重写（中文+badge+中英链接）· 验证 pnpm install ✅ pnpm lint ✅ pnpm format:check ✅ pnpm build ✅ 风险 低（仅元信息/文档/模板，无代码行为变更）下一步 可领 T-014 批2 文档与架构 |
| _在此追加_ |                     |                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
