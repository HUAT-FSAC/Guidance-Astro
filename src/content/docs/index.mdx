...
<footer class="home-footer">
  ...
  <div style="display: flex; justify-content: center; gap: 2rem; flex-wrap: wrap; margin-bottom: 2rem;">
    <a href="https://github.com/HUAT-FSAC" class="footer-link" target="_blank" rel="noopener noreferrer" aria-label="访问我们的 GitHub 页面">
      GitHub
    </a>
    <a href="mailto:contact@huat-fsac.eu.org" class="footer-link" rel="noopener noreferrer" aria-label="通过邮件联系我们">
      联系我们
    </a>
