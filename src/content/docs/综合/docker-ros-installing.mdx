...
2. **验证安装**
   ...
   ![docker-version](../../../assets/docs/docker-ros-installing/docker-version.png)
...
![docker-terminal](../../../assets/docs/docker-ros-installing/docker-terminal.png)
...
![cant_connect](../../../assets/docs/docker-ros-installing/cant_connect.png)
...
<CardGrid>
  <Card title="rqt 启动成功">
    ![rqt_start](../../../assets/docs/docker-ros-installing/rqt_start.png)
  </Card>
  <Card title="rviz 启动成功">
    ![docker-rviz](../../../assets/docs/docker-ros-installing/docker-rviz.png)
  </Card>
</CardGrid>
