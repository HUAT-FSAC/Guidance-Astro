...
<CardGrid stagger>
    <Card title="激光雷达感知" icon="star">
        - 点云预处理 - 地面分割 - 锥桶聚类 - 位置估计
    </Card>
    <Card title="视觉感知" icon="magnifier">
        - 图像预处理 - 目标检测 (YOLO) - 颜色分类 - 距离估计
    </Card>
...
<CardGrid>
    ...
    />
    <LinkCard title="激光雷达教程" description="激光雷达点云处理入门" href="/感知/激光雷达/" />
    <LinkCard title="摄像头视觉" description="工业相机与视觉感知" href="/感知/摄像头/" />
</CardGrid>
