 ...
 * @example
 * ```typescript
 * import { copyToClipboard, generateShareUrl, nativeShare } from '../utils/share-utils';
 * 
 * // 复制链接
 ...
 * 分享平台类型
 */
export type SharePlatform = 'twitter' | 'weibo' | 'wechat' | 'linkedin' | 'facebook' | 'telegram' | 'email';
